...
__export(react_exports, {
  ...
  AccessibilityWidget: () => AccessibilityWidget2,
  ReactAccessibilityWidget: () => ReactAccessibilityWidget,
  auditAccessibility: () => auditAccessibility,
  generateAccessibilityStatement: () => generateAccessibilityStatement,
  useAccessibilityWidget: () => useAccessibilityWidget
});
...
// src/core/icons.ts
var import_a_large_small = require("lucide-react/dist/esm/icons/a-large-small.mjs");
var import_between_horizontal_start = require("lucide-react/dist/esm/icons/between-horizontal-start.mjs");
var import_between_vertical_start = require("lucide-react/dist/esm/icons/between-vertical-start.mjs");
var import_book_open_text = require("lucide-react/dist/esm/icons/book-open-text.mjs");
var import_brain = require("lucide-react/dist/esm/icons/brain.mjs");
var import_chevron_down = require("lucide-react/dist/esm/icons/chevron-down.mjs");
var import_chevron_up = require("lucide-react/dist/esm/icons/chevron-up.mjs");
var import_circle = require("lucide-react/dist/esm/icons/circle.mjs");
var import_circle_off = require("lucide-react/dist/esm/icons/circle-off.mjs");
var import_contrast = require("lucide-react/dist/esm/icons/contrast.mjs");
var import_eye = require("lucide-react/dist/esm/icons/eye.mjs");
var import_external_link = require("lucide-react/dist/esm/icons/external-link.mjs");
var import_focus = require("lucide-react/dist/esm/icons/focus.mjs");
var import_heading = require("lucide-react/dist/esm/icons/heading.mjs");
var import_image_off = require("lucide-react/dist/esm/icons/image-off.mjs");
var import_landmark = require("lucide-react/dist/esm/icons/landmark.mjs");
var import_layers = require("lucide-react/dist/esm/icons/layers.mjs");
var import_link = require("lucide-react/dist/esm/icons/link.mjs");
var import_monitor_pause = require("lucide-react/dist/esm/icons/monitor-pause.mjs");
var import_moon = require("lucide-react/dist/esm/icons/moon.mjs");
var import_mouse_pointer_2 = require("lucide-react/dist/esm/icons/mouse-pointer-2.mjs");
var import_move_horizontal = require("lucide-react/dist/esm/icons/move-horizontal.mjs");
var import_palette = require("lucide-react/dist/esm/icons/palette.mjs");
var import_rotate_ccw = require("lucide-react/dist/esm/icons/rotate-ccw.mjs");
var import_rows_3 = require("lucide-react/dist/esm/icons/rows-3.mjs");
var import_scan_eye = require("lucide-react/dist/esm/icons/scan-eye.mjs");
var import_sun_dim = require("lucide-react/dist/esm/icons/sun-dim.mjs");
var import_sun = require("lucide-react/dist/esm/icons/sun.mjs");
var import_text_align_center = require("lucide-react/dist/esm/icons/text-align-center.mjs");
var import_text_align_end = require("lucide-react/dist/esm/icons/text-align-end.mjs");
var import_text_align_justify = require("lucide-react/dist/esm/icons/text-align-justify.mjs");
var import_text_align_start = require("lucide-react/dist/esm/icons/text-align-start.mjs");
var import_text_initial = require("lucide-react/dist/esm/icons/text-initial.mjs");
var import_venetian_mask = require("lucide-react/dist/esm/icons/venetian-mask.mjs");
var import_volume_2 = require("lucide-react/dist/esm/icons/volume-2.mjs");
var import_whole_word = require("lucide-react/dist/esm/icons/whole-word.mjs");
var import_x = require("lucide-react/dist/esm/icons/x.mjs");
var import_zap = require("lucide-react/dist/esm/icons/zap.mjs");
var import_zoom_in = require("lucide-react/dist/esm/icons/zoom-in.mjs");
var import_ear = require("lucide-react/dist/esm/icons/ear.mjs");
var import_keyboard = require("lucide-react/dist/esm/icons/keyboard.mjs");
var import_book_a = require("lucide-react/dist/esm/icons/book-a.mjs");
var import_sparkles = require("lucide-react/dist/esm/icons/sparkles.mjs");
var import_square_dashed_mouse_pointer = require("lucide-react/dist/esm/icons/square-dashed-mouse-pointer.mjs");
...
var ICONS = {
  trigger: triggerSvg(),
  close: lucideSvg(import_x.__iconNode),
  reset: lucideSvg(import_rotate_ccw.__iconNode),
  chevronDown: lucideSvg(import_chevron_down.__iconNode),
  chevronUp: lucideSvg(import_chevron_up.__iconNode),
  info: '<span class="accessibility-widget-info-glyph">i</span>',
  // Product and profile icons.
  wheelchair: triggerSvg(),
  seizure: lucideSvg(import_zap.__iconNode),
  vision: lucideSvg(import_eye.__iconNode),
  lightSensitivity: lucideSvg(import_sun_dim.__iconNode),
  adhd: lucideSvg(import_focus.__iconNode),
  cognitive: lucideSvg(import_brain.__iconNode),
  colorBlind: lucideSvg(import_palette.__iconNode),
  dyslexia: lucideSvg(import_book_open_text.__iconNode),
  keyboardMotor: lucideSvg(import_keyboard.__iconNode),
  blindScreenReader: lucideSvg(import_ear.__iconNode),
  // Content adjustments.
  legibleFonts: lucideSvg(import_text_initial.__iconNode),
  dyslexiaFriendlyFont: lucideSvg(import_whole_word.__iconNode),
  highlightTitles: lucideSvg(import_heading.__iconNode),
  fontSizing: lucideSvg(import_a_large_small.__iconNode),
  textMagnifier: lucideSvg(import_zoom_in.__iconNode),
  readingLens: lucideSvg(import_scan_eye.__iconNode),
  bigCursor: lucideSvg(import_mouse_pointer_2.__iconNode),
  readingMask: lucideSvg(import_rows_3.__iconNode),
  readingGuide: lucideSvg(import_move_horizontal.__iconNode),
  readAloud: lucideSvg(import_volume_2.__iconNode),
  dictionary: lucideSvg(import_book_a.__iconNode),
  simplify: lucideSvg(import_sparkles.__iconNode),
  virtualKeyboard: lucideSvg(import_keyboard.__iconNode),
  focusHighlight: lucideSvg(import_square_dashed_mouse_pointer.__iconNode),
  highlightLinks: lucideSvg(import_link.__iconNode),
  lineHeight: lucideSvg(import_between_vertical_start.__iconNode),
  letterSpacing: lucideSvg(import_between_horizontal_start.__iconNode),
  textAlignLeft: lucideSvg(import_text_align_start.__iconNode),
  textAlignCenter: lucideSvg(import_text_align_center.__iconNode),
  textAlignRight: lucideSvg(import_text_align_end.__iconNode),
  textAlignJustify: lucideSvg(import_text_align_justify.__iconNode),
  pageStructure: lucideSvg(import_layers.__iconNode),
  structureLandmark: lucideSvg(import_landmark.__iconNode),
  structureLink: lucideSvg(import_link.__iconNode),
  structureExternal: lucideSvg(import_external_link.__iconNode),
  // Visual adjustments.
  darkContrast: lucideSvg(import_moon.__iconNode),
  lightContrast: lucideSvg(import_sun.__iconNode),
  highContrast: lucideSvg(import_contrast.__iconNode),
  monochrome: lucideSvg(import_circle.__iconNode),
  invertColors: lucideSvg(import_circle_off.__iconNode),
  colorBlindVisual: lucideSvg(import_venetian_mask.__iconNode),
  hideImages: lucideSvg(import_image_off.__iconNode),
  offAnimations: lucideSvg(import_monitor_pause.__iconNode)
};
...
function useAccessibilityWidget(config = {}) {
  ...
  const setAccentColor = (0, import_react2.useCallback)((accentColor) => {
    instanceRef.current?.setAccentColor(accentColor);
  }, []);
  const setTheme = (0, import_react2.useCallback)((theme) => {
